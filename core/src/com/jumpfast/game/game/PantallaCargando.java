 ...
 *
 * Pantalla que se ejecuta cuando se abre el juego
 */

public class PantallaCargando extends PantallaInicio{
    ...
    public PantallaCargando(MainGame game) {
        super(game);
    ...
    public void render(float delta) {
        ...
        if (juego.getManager().update()) {
            ...
            int progress = (int) (juego.getManager().getProgress() * 100);
