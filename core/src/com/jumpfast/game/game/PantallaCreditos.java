...
public class PantallaCreditos extends PantallaInicio{
    ...
    public PantallaCreditos(final MainGame game) {
        super(game);
        ...
        credits = new Label("Jump Fast v1\n" +
                "Copyright (C) 2017 Carlos Prieto\n" +
                "Me gusta el cochinito con mojo picon gueno gueno\n\n" +

                "Musica: \"Long Time Coming\" Kevin MacLeod (incompetech.com)\n" +
                "Viva er beti siempre coño", skin);
