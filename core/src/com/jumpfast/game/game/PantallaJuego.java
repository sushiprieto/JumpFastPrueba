...
import com.jumpfast.game.game.entities.EntityFactory;
import com.jumpfast.game.game.entities.EntidadPincho;
import com.jumpfast.game.game.entities.EntidadSuelo;
import com.jumpfast.game.game.entities.EntidadJugador;

/**
 * Created by cprieto on 9/02/17.
 */

public class PantallaJuego extends PantallaInicio {
    ...
    @Override
    public void show() {
        EntityFactory factory = new EntityFactory(juego.getManager());
                    ...
                    stage.addAction(
                            Actions.sequence(
                                    ...
                                    Actions.run(new Runnable() {
                                        ...
                                        @Override
                                        public void run() {
                                            juego.setScreen(juego.pantallaGameOver);
                                        }
                                    })
                            )
                    );
